...
class BurgerMachine:
    ...
    UCID: mm2836
    Date: 03/13/23
    Summary: Returns cost of burger by looping through each element in the inprogress_burger list
        and getting the associated cost of each item.
    '''
    ...
    def run(self):
        ...
        # handle NeedsCleaningException
            ...
            clean = input("Machine needs cleaning. Type 'clean' to clean the machine.").lower()
        ...
        # handle ExceededRemainingChoicesException
            ...
            print(f'{self.currently_selecting} has exceeded the maximum number of choices.')
